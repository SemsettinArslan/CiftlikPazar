...
export default function EditAddressScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('Adres güncelleme isteği gönderiliyor...');
      ...
      console.log('Adres güncelleme yanıtı:', response.data);
      ...
      if (response.data.success) {
        ...
        setError(response.data.message || 'Adres güncellenirken bir hata oluştu');
      }
    } catch (err: any) {
      console.error('Adres güncelleme hatası:', err);
      setError(
        err.response?.data?.message || 'Adres güncellenirken bir hata oluştu'
      );
    } finally {
      setIsSaving(false);
    }
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.switchGroup}>
            ...
            <Switch
              ...
              disabled={formData.isDefault} // Zaten varsayılansa değiştirilemez
            />
          </View>
          <Text style={styles.helperText}>
            {formData.isDefault 
              ? 'Bu adres varsayılan olarak ayarlanmış.'
              : 'Bu adres teslimat için varsayılan olarak kullanılacaktır.'}
          </Text>
